...
namespace AssetStudio.PInvoke
{
    public static class DllLoader
    {
        ...
        {
            var dllDir = GetDirectedDllDirectory(dllName);
        ...
        private static string GetDirectedDllDirectory(string dllName)
        {
            ...
            if (!File.Exists(Path.Combine(directedDllDir, $"{dllName}.dll")))
            {
                directedDllDir = Path.Combine(Path.GetTempPath(), "AssetStudio.Native", typeof(DllLoader).Assembly.ManifestModule.ModuleVersionId.ToString("N"), subDir);
                Directory.CreateDirectory(directedDllDir);
                var assembly = typeof(DllLoader).Assembly;
                var prefix = $"AssetStudio.Native.{subDir}.";
                foreach (var resourceName in assembly.GetManifestResourceNames())
                {
                    ...
                    var filePath = Path.Combine(directedDllDir, fileName);
